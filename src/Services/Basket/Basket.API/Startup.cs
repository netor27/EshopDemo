...
using System.Net;
using Demo.Services.Basket.API.Auth.Server;
using Demo.BuildingBlocks.EventBus.Abstractions;
using Demo.Services.Basket.API.IntegrationEvents.Events;
using Demo.Services.Basket.API.IntegrationEvents.EventHandling;
using Demo.BuildingBlocks.EventBusRabbitMQ;
using System;
...
namespace Demo.Services.Basket.API
{
